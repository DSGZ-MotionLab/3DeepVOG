...
def fit_legrand_model(eyeball_params, df_gaze_tp, torsion_tp, large_meshes, small_meshes, num_grids=25, use_mask=True):
    ...
    return {
        "eyeball_mesh": large_coords_masked, "corneaball_mesh": small_coords_masked,
        "limbus_circle_points": limbus_circle_points, "pupil_circle_points": pupil_circle_points,
        "pupil_center": c_pupil, "pupil_center_unc": c_pupil_unc,
        "entpup_el": entpup_el, "gaze_vec": gaze_vec, "eyeball_center": c_eye, "corneaball_center": c_cornea
    }
