...
class TorsionTracker(threading.Thread):
    def __init__(self, threads, args, daemon=False, use_queue=True):
        ...
        self.canonical_eyeball_radius = 12.0*self.mm2px
    ...
    def torsion_tracker(self, frame_batch):
        ...
        good_pattern_brightness = (quality_measures_batch['pattern_brightness'] > self.args['th_under_exposure']) & (quality_measures_batch['pattern_brightness'] < self.args['th_over_exposure'])
